...
Normally, the location of an vehicle is updated based on
$$
...
- **Cars** are those small dots. The color indicates the speed. The faster a car goes, the warmer the color will be. It is not illustrated in this screenshot, but it is quite obvious in a movie.
- Sometimes you may notice a lot of dots crowded in one node
![ff](1.png)
